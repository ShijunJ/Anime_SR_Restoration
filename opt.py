...
# File Setting
opt['input_path'] = "My Low Quality Academia.mp4"      # The path to the input folder/images (can detect automatically)
opt['store_path'] = "result/output.mp4"     # The path to stored the super-resolved images/videos
